...
from homework_2.common.variables import RESPONSE, ERROR, USER, ACCOUNT_NAME, TIME, ACTION, PRESENCE
from homework_2.client import create_presence, process_response_ans
