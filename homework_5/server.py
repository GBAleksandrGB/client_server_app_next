...
from homework_5.common.decos import log
from homework_5.common.utils import get_message, send_message
from homework_5.common.variables import DESTINATION, SENDER, ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, RESPONSE_200, \
    RESPONSE_400, ERROR, MESSAGE_TEXT, MESSAGE, EXIT, GET_CONTACTS, RESPONSE_202, LIST_INFO, ADD_CONTACT, \
