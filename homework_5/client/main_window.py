...
from homework_5.client.main_window_conv import Ui_MainClientWindow
from homework_5.client.add_contact import AddContactDialog
from homework_5.client.del_contact import DelContactDialog
