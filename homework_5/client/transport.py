...
from homework_5.common.errors import ServerError
from homework_5.common.utils import send_message, get_message
from homework_5.common.variables import ACTION, PRESENCE, ACCOUNT_NAME, USER, TIME, RESPONSE, ERROR, DESTINATION, \
    MESSAGE, SENDER, MESSAGE_TEXT, GET_CONTACTS, LIST_INFO, USERS_REQUEST, ADD_CONTACT, REMOVE_CONTACT, EXIT
