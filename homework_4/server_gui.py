...
from PyQt5.QtWidgets import QMainWindow, QAction, qApp, QApplication, QLabel, QDialog, QPushButton, \
    QLineEdit, QFileDialog, QTableView


def gui_create_model(database):
    list_users = database.active_users_list()
    list_table = QStandardItemModel()
    list_table.setHorizontalHeaderLabels(['Имя клиента', 'IP-адрес', 'Порт', 'Подключение'])
...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.db_path_label = QLabel('Путь до файла база данных: ', self)
        self.db_path_label.move(18, 18)
        self.db_path_label.setFixedSize(248, 15)
        ...
        self.db_file_label.move(180, 15)
        ...
        self.ip_label_note = QLabel(' оставьте это поле пустым, чтобы\n принимать соединения в любых адресов', self)
...
if __name__ == '__main__':
    ...
    test_list.appendRow(
        [QStandardItem('test1'), QStandardItem('192.168.8.5'), QStandardItem('23544'), QStandardItem('16:17:34')])
    ...
    # test_list.appendRow(
    #     [QStandardItem('test1'), QStandardItem('Fri Dec 12 16:28:34 2828'), QStandardItem('2'), QStandardItem('3')])
